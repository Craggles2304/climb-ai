...
const game=(id:string,score:number):Match=>({id,accountId:'a',champion:'Ahri',role:'MID',result:'LOSS',kills:1,deaths:4,assists:3,cs:180,durationMin:30,playedAt:'2026-09-16T10:00:00Z',metrics:{csPerMin:6},proAnalysis:{matchId:id,accountId:'a',generatedAt:'2026-09-16T10:00:00Z',metrics:{reset_quality:metric(score)} as any,leakSignals:[],fingerprint:{primary:'reset_quality',sequence:[],confidence:'HIGH',explanation:'test'}} as any});
