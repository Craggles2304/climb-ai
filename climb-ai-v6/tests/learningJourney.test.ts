...
test('Progress page exposes the evidence-bounded Learning Journey and the server persists it',()=>{
  ...
  assert.ok(repo.includes('learningJourney,decisionTwinV2,scenarioMemory,decisionTransfer,skillTransferGraph,decisionPrincipleEngine,curriculum,patchContext,roleAwareLearning,generatedAt:now'));
});
