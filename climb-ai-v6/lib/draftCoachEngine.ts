...
export function buildRankAwareDraftPlan(input:CoachEngineInput):CoachEnginePlan{
  ...
  if(role==='ADC'){
    ...
    if(rangedTop){
      ...
      objectiveSetup=`${champion} PUSHES THE SAFE SIDE WAVE → ARRIVE BEFORE SPAWN → TAKE A SECOND-LINE / SIDE ANGLE SO ${threatText} MUST ENTER YOUR REAL FRONT EDGE FIRST.`;
