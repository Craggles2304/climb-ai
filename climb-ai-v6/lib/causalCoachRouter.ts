...
const REVIEW_BOUNDARY='ROUTE REVIEW COMPARES THE FROZEN PRE-GAME COACHING LAYER WITH THE POST-GAME VERIFIED CAUSAL CHAIN. IT DOES NOT CLAIM THE ROUTED COACHING CAUSED THE RESULT. A MISMATCH IS ONE NEW EVIDENCE POINT, NOT AN AUTOMATIC MODEL REWRITE.';
