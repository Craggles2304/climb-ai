...
objective_wave:{roles:['ADC','MID','TOP'],title:'Decide the final wave before objective setup',category:'TEMPO',why:'Wave and objective conflicts are usually created before the objective spawns.',gameRule:'At 90 seconds before Dragon or Baron, choose your final wave and route.',metric:'objectivePreparation',target:'3 correct reviewed setup decisions',priority:86,masteryRequired:3},
