...
export function buildFrozenContingencyMap(input:{
  ...
  return{
    ...
    boundary:'OP CLIMB NEVER AUTO-SWITCHES THE WIN CONDITION. IT DOES NOT DETECT THAT THE WIN CONDITION CHANGED. THE PLAYER SELECTS PLAN A / PLAN B / RECOVERY FROM THE LIVE GAME THEY CAN SEE; EVERY RESPONSE WAS WRITTEN BEFORE THE GAME.',
  };
}
