...
const routeScene=(path:string):RouteScene|null=>{
  ...
  if(path==='/ilp')return{code:'CLIMB // 04',kicker:'PLAYER DEVELOPMENT',title:'BUILD A PLAYER. NOT A STATLINE.',copy:'Two active missions, clear evidence and a development path that only moves when repeated performance earns it.',signals:['CURRENT PLAN','EVIDENCE','MASTERY'],tone:'climb',watermark:'GROW'};
