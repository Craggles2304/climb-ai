  ...
  return <details {...revealProps(mounted,index,'vf-track')}>
    <summary>
      ...
      <div className="vf-track-main">
        ...
        <div className="vf-track-pass"><Pips passes={done} required={req}/><span>{done}/{req} GOOD GAMES</span></div>
      </div>
...
export default function PlayerDevelopmentCentre(){
  ...
  return <AppShell>
    ...
    <section className="vf-section-head"><div><div className="eyebrow">YOUR ACTIVE FIVE</div><h2>Five things. #1 matters most.</h2></div>{detail.depth>=4&&<Link href="/progress">HISTORY →</Link>}</section>
    ...
    {detail.depth>=3&&<details className="glass card vf-how">
      ...
      <div className="vf-how-grid">
        <div><b>01</b><span>PLAY</span><p>Tracked games test the behaviour.</p></div>
        <div><b>02</b><span>PASS</span><p>Do it well and bank a good game.</p></div>
        <div><b>03</b><span>MASTER</span><p>Repeat it enough and it is mastered.</p></div>
        <div><b>04</b><span>REPLACE</span><p>A new priority automatically takes the empty spot.</p></div>
      </div>
    </details>}
