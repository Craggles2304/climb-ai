...
export default function TftHome(){
  ...
  return <TftShell><main className="container section">
    ...
    <section style={{display:'grid',gridTemplateColumns:'minmax(0,1.5fr) minmax(260px,.7fr)',gap:16,marginTop:18}}>
      ...
      <div className="glass card"><div className="eyebrow">NO-KEY TOOLKIT</div><h3>STATIC + SCENARIO TOOLS</h3><p className="muted">Current system math and Riot static data do not require a Riot match API key.</p><Link className="btn primary" href="/tft/roll-lab">OPEN ROLL LAB</Link><Link className="btn secondary" href="/tft/augment-lab" style={{marginTop:8}}>OPEN AUGMENT LAB</Link><Link className="btn secondary" href="/tft/item-finder" style={{marginTop:8}}>OPEN ITEM FINDER</Link><Link className="btn secondary" href="/tft/carry-builder" style={{marginTop:8}}>OPEN CARRY BUILDER</Link><Link className="btn secondary" href="/tft/board-lab" style={{marginTop:8}}>OPEN BOARD LAB</Link><Link className="btn secondary" href="/tft/coach" style={{marginTop:8}}>OPEN TFT COACH</Link></div>
    </section>
  </main></TftShell>;
}