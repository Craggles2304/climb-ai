...
export default function Demo(){return <>
  ...
  <main className="container demo-page">
    ...
    <section className="demo-panel demo-live-sample" id="live-demo">
      ...
      <details className="demo-detail"><summary>OPEN ONE COACHING MOMENT</summary><div><b>10:37 · CHECK</b><span>Map window: no major objective evidence nearby.</span><span>Next rule: do not force a rotation just because teammates are moving. Finish the safe resource or create a numbers edge first.</span></div></details>
    </section>

    <section className="demo-pricing"><div><div className="eyebrow">SUBSCRIPTIONS</div><h2>THE HIGHER THE TIER, THE DEEPER THE DIAGNOSIS.</h2></div><div className="demo-plan-row"><div><b>FREE</b><span>Grade + basic fixes</span></div><div><b>PLUS</b><span>Economy + fight-state coaching</span></div><div className="is-pro"><b>PRO</b><span>Decision Fingerprint + full history</span></div></div><Link className="text-link" href="/pricing">COMPARE ALL PLANS →</Link></section>

    <section className="demo-cta"><div className="eyebrow">READY TO USE YOUR OWN EVIDENCE?</div><h2>PLAY. REVIEW. FIX ONE THING. PROVE IT.</h2><div><Link className="btn primary" href="/signup">CREATE FREE ACCOUNT</Link><Link className="btn secondary" href="/login">I ALREADY HAVE ONE</Link></div></section>
  </main>
  <PublicFooter/>
</>}
