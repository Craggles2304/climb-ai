...
`;
    ...
    section.innerHTML=`
      ...
      <div class="rem4-body">
        ...
        <section class="rem4-call-row">
          <article class="rem4-call"><span class="rem4-label">MATCH CALL</span><strong id="opRemGameCall">FARM TO SPIKE</strong><small id="opRemGameCallWhy">PROTECT CS / XP · FIGHT ON YOUR ITEM WINDOW</small></article>
  ...
  function render(state){
    ...
    set('opRemGameCall',call.call,'PLAY MID GAME');set('opRemGameCallWhy',call.why,'FARM CLEAN · FIGHT WITH SETUP');
