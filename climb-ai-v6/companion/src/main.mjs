...
const WEB=process.env.CLIMB_WEB_URL||'http://localhost:3000';
const ACCOUNT=process.env.CLIMB_ACCOUNT_ID||'acct-main';
...
console.log('CLIMB Companion prototype: silent telemetry only. No automated tactical instructions.');
